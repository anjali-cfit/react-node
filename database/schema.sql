...
-- Indexes for efficient product queries
...
COMMENT ON COLUMN orders.total_amount IS 'Total order amount at time of purchase';
...
-- ORDER ITEMS TABLE
-- ==========================================
-- Items in orders (snapshot of product at time of purchase)
...
COMMENT ON TABLE order_items IS 'Items in orders - stores snapshot of product details';
COMMENT ON COLUMN order_items.product_name IS 'Product name at time of purchase';
COMMENT ON COLUMN order_items.product_price IS 'Product price at time of purchase';
